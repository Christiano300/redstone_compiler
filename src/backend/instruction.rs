...
table_enum! {
    ...
    SVA("SVA", false, false, 4, false, false, true),
    ...
    ADD("ADD", false, false, 10, true, true, false),
    SUB("SUB", false, false, 11, true, true, false),
    AND("AND", false, false, 12, true, true, false),
    OR("OR", false, false, 13, true, true, false),
    XOR("XOR", false, false, 14, true, true, false),

    SUP("SUP", false, false, 15, false, true, true),
    SDN("SDN", false, false, 16, false, true, true),
    MUL("MUL", false, false, 17, false, true, false),

    RW("RW", false, false, 18, true, false, false),
    RR("RR", false, false, 19, true, false, false),
    RC("RC", false, false, 20, false, false, false),

    INB("INB", false, false, 21, false, false, false),

    JMP("JMP", false, true, 0, true, false, true),
    JE("JE", false, true, 1, true, false, true),
    JNE("JNE", false, true, 2, true, false, true),
    JG("JG", false, true, 3, true, false, true),
    JGE("JGE", false, true, 4, true, false, true),
    JL("JL", false, true, 5, true, false, true),
    JLE("JLE", false, true, 6, true, false, true),

    JMD("JMD", true, true, 0, true, false, true),
    JDE("JDE", true, true, 1, true, false, true),
    JDN("JDN", true, true, 2, true, false, true),
    JDG("JDG", true, true, 3, true, false, true),
    JDGE("JDGE", true, true, 4, true, false, true),
    JDL("JDL", true, true, 5, true, false, true),
    JDLE("JDLE", true, true, 6, true, false, true),

    SMP("SMP", false, true, 0, true, false, true),
    SE("SE", false, true, 1, true, false, true),
    SNE("SNE", false, true, 2, true, false, true),
    SG("SG", false, true, 3, true, false, true),
    SGE("SGE", false, true, 4, true, false, true),
    SL("SL", false, true, 5, true, false, true),
    SLE("SLE", false, true, 6, true, false, true),

    SMD("SMD", true, true, 0, true, false, true),
    SDE("SDE", true, true, 1, true, false, true),
    SDNE("SDNE", true, true, 2, true, false, true),
    SDG("SDG", true, true, 3, true, false, true),
    SDGE("SDGE", true, true, 4, true, false, true),
    SDL("SDL", true, true, 5, true, false, true),
    SDLE("SDLE", true, true, 6, true, false, true),
