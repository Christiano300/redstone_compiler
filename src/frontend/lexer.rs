...
mod test {
    ...
    fn token_types(code: &str) -> Result<Vec<TokenType>, Error> {
    ...
    use crate::{
        Error,
        frontend::{EqualityOperator, Operator, TokenType, tokenize},
    };
    ...
    fn operators() {
        ...
        let expected: Vec<_> = ops
            ...
            .collect();
        let ast = token_types(code).expect("Code to compile");
